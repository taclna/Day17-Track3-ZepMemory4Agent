...
- Average retrieval latency: **837.8 ms**
- Average token reduction vs full source context: **14.2%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.1 | 133 | 0.0% |  |
| E06 | semantic | PASS | 632.4 | 148 | 67.8% |  |
| E09 | long_term | PASS | 1362.6 | 834 | 0.0% |  |
| E10 | short_term | PASS | 0.3 | 195 | 0.0% |  |
| E02 | long_term | PASS | 1337.4 | 1482 | 0.0% |  |
| E03 | long_term | PASS | 1443.8 | 1480 | 0.0% |  |
| E04 | episodic | PASS | 246.0 | 284 | 0.0% |  |
| E05 | episodic | PASS | 291.9 | 303 | 0.0% |  |
| E07 | mixed | PASS | 2078.1 | 485 | 14.2% |  |
| E11 | semantic | PASS | 275.6 | 146 | 74.2% |  |
| E08 | long_term | PASS | 1548.0 | 1460 | 0.0% |  |
...
`<USER_SUMMARY> The user's personal project is named ORCHID-27, for which they prefer to use Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used for this specific backend project. The user needs to complete a benchmark report by Friday at 16:00 for an open loop called LAB-REPORT-1600. The user was debugging async HTTP requests and resolved connection churn for the ASYNC-FIX-20 incident by reusing the aiohttp ClientSession and setting concurrency to 20.  Minh prefers Python and dislikes Java. When explaining code, use short examples. Minh prefers to use a timeline when explaining coroutines and Tasks. For the company project BL`
...
`<LONG_TERM> <USER_SUMMARY> The user's personal project is named ORCHID-27, for which they prefer to use Python. For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used for this specific backend project. The user needs to complete a benchmark report by Friday at 16:00 for an open loop called LAB-REPORT-1600. The user was debugging async HTTP requests and resolved connection churn for the ASYNC-FIX-20 incident by reusing the aiohttp ClientSession and setting concurrency to 20.  Minh prefers Python and dislikes Java. When explaining code, use short examples. Minh prefers to use a timeline when explaining coroutines and Tasks. For the compan`
